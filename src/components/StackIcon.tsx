...
export const STACKS = [
  {
    Icon: <SiAlgolia className="w-10 h-10 fill-gray-700  dark:fill-gray-200" />,
  ...
  {
    Icon: (
      <SiAmazonaws className="w-10 h-10 fill-gray-700  dark:fill-gray-200" />
    ),
  ...
  {
    Icon: (
      <SiChakraui className="w-10 h-10 fill-gray-700  dark:fill-gray-200" />
    ),
  ...
  {
    Icon: <SiCss3 className="w-10 h-10 fill-gray-700  dark:fill-gray-200" />,
    url: 'https://golang.org/',
    iconTitle: 'CSS3',
    color: '#FFC107'
  },
  {
    Icon: <SiDebian className="w-10 h-10 fill-gray-700  dark:fill-gray-200" />,
  ...
  {
    Icon: <SiDocker className="w-10 h-10 fill-gray-700  dark:fill-gray-200" />,
    url: 'https://kubernetes.io/',
    iconTitle: 'Docker',
    color: '#FFC107'
  },
  {
    Icon: <SiExpress className="w-10 h-10 fill-gray-700  dark:fill-gray-200" />,
    url: 'https://www.typescriptlang.org/',
    iconTitle: 'Express',
    color: '#FFC107'
  },
  {
    Icon: <SiFigma className="w-10 h-10 fill-gray-700  dark:fill-gray-200" />,
  ...
  {
    Icon: (
      <SiFirebase className="w-10 h-10 fill-gray-700  dark:fill-gray-200" />
    ),
  ...
  {
    Icon: <SiFramer className="w-10 h-10 fill-gray-700  dark:fill-gray-200" />,
    url: 'https://aws.amazon.com/',
    iconTitle: 'Framer',
    color: '#FFC107'
  },
  {
    Icon: <SiGraphql className="w-10 h-10 fill-gray-700  dark:fill-gray-200" />,
    url: 'https://graphql.org/',
    iconTitle: 'GraphQL',
    color: '#FFC107',
    featured: true
  ...
  {
    Icon: <SiHeroku className="w-10 h-10 fill-gray-700  dark:fill-gray-200" />,
    url: 'https://elixir-lang.org/',
    iconTitle: 'Heroku',
    color: '#FFC107'
  },
  {
    Icon: <SiJest className="w-10 h-10 fill-gray-700  dark:fill-gray-200" />,
    url: 'https://jestjs.io/',
    iconTitle: 'Jest',
    color: '#FFC107',
    featured: true
  ...
  {
    Icon: <SiLinux className="w-10 h-10 fill-gray-700  dark:fill-gray-200" />,
  ...
  {
    Icon: <SiMapbox className="w-10 h-10 fill-gray-700  dark:fill-gray-200" />,
    url: 'https://www.postgresql.org/',
    iconTitle: 'Mapbox',
    color: '#FFC107'
  },
  {
    Icon: <SiMysql className="w-10 h-10 fill-gray-700  dark:fill-gray-200" />,
  ...
  {
    Icon: (
      <SiNodedotjs className="w-10 h-10 fill-gray-700  dark:fill-gray-200" />
    ),
    url: 'https://www.postgresql.org/',
    iconTitle: 'Node.js',
    color: '#FFC107'
  ...
  {
    Icon: (
      <SiNextdotjs className="w-10 h-10 fill-gray-700  dark:fill-gray-200" />
    ),
  ...
  {
    Icon: (
      <SiPostgresql className="w-10 h-10 fill-gray-700  dark:fill-gray-200" />
    ),
  ...
  {
    Icon: <SiPrisma className="w-10 h-10 fill-gray-700  dark:fill-gray-200" />,
  ...
  {
    Icon: <SiPnpm className="w-10 h-10 fill-gray-700  dark:fill-gray-200" />,
    url: 'https://www.python.org/',
    iconTitle: 'PnPM',
    color: '#FFC107'
  },
  {
    Icon: <SiReact className="w-10 h-10 fill-gray-700  dark:fill-gray-200" />,
  ...
  {
    Icon: (
      <SiSupabase className="w-10 h-10 fill-gray-700  dark:fill-gray-200" />
    ),
  ...
  {
    Icon: (
      <SiTailwindcss className="w-10 h-10 fill-gray-700  dark:fill-gray-200" />
    ),
  ...
  {
    Icon: (
      <SiTypescript className="w-10 h-10 fill-gray-700  dark:fill-gray-200" />
    ),
    featured: true,
    url: 'https://www.typescriptlang.org/',
  ...
  {
    Icon: <SiVercel className="w-10 h-10 fill-gray-700  dark:fill-gray-200" />,
...
export default function StackIcon({ iconTitle, isLink = false }: IStackIcon) {
  ...
  return isLink ? (
    <a
      className={cn(
        'delay-100 fill-gray-700  dark:fill-gray-200  transform  duration-150 hover:translate-y-1'
      )}
      href={url}
    >
      {Icon}
