  ...
  return (
    <Container title="404 – Dzmitry Svirin">
      <div className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16">
        ...
        <Link href="/">
          <a className="p-1 transition-all dark:hover:text-signal   hover:text-signal delay-150  sm:p-4 w-64 font-semibold mx-auto bg-gray-200 dark:bg-gray-800 text-center rounded-md text-black dark:text-white">
            Return Home
          </a>
        </Link>
      </div>
