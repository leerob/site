      ...
      <div className="flex flex-col  max-w-2xl mx-auto pb-16 w-full">
        <div className="relative w-full mt-4 mb-2">
          <input
            ...
            className="block w-full px-4 py-2 text-gray-900 bg-gray-50 border border-gray-200 rounded-md dark:border-gray-700  dark:bg-gray-800 dark:text-gray-100 focus:border-active focus-visible:ring-1 focus:ring-active focus:outline-none md:text-lg"
          />
          <svg
