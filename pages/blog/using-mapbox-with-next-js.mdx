...
-   It uses [OpenStreetMap](https://www.openstreetmap.org/) under the hood, which is <Link slug="blog/why-i-create-open-source-software" title="Why I Create Open-Source Software" underline={true}>open-source</Link>.
...
-   When importing dynamic components, you can supply a [loading placeholder](https://nextjs.org/docs/#2-with-custom-loading-component). <Link slug="blog/loading-placeholder-with-sass" title="Creating a Loading Placeholder with Sass" underline={true}>Here's an example</Link> of one you could create.
