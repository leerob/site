...
image: '/static/images/nextjs-authentication/banner.jpg'
---
...
When using [Firebase Authentication](/blog/nextjs-firebase-serverless), I recommend using the static generation pattern. There currently isn't a way to log-in server-side using the Firebase Admin SDK.
