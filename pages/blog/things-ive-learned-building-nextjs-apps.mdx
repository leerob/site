...
**Bonus:** Next won't prefetch [if the user is on 2G](https://github.com/zeit/next.js/blob/fc19b233ebcb6074a55ef4a00771ef7b0a3bcc33/packages/next/client/page-loader.js#L137-L143), since that would actually be a worse experience. Pretty neat!
