...
While this works, we can go a step further and provide a <Link slug="blog/loading-placeholder-with-sass" title="Creating a Loading Placeholder with Sass" underline={true}>loading placeholder</Link> to make the user experience better.
...
My <Link slug="blog/beginners-guide-to-the-programming-portfolio" title="Beginner’s Guide to the Programming Portfolio" underline={true}>portfolio</Link> has transformed quite a bit since I started it in 2014. Originally, it was
