...
export const meta = {
date: '2017-10-02',
description: 'What I learned from this engineering management conference.',
...
![Calibrate Conference in San Francisco, CA](/static/images/calibrate-san-francisco/banner.png)
...
-   Iowa? Why Iowa?
-   What is Workiva? _(Hint: You can find the answer <Link slug="blog/life-at-workiva" title="Life at Workiva" >here</Link>)_
