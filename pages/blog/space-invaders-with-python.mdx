...
image: '/static/images/space-invaders-with-python/banner.png',
...
<DateAndViews date={meta.date} id="space-invaders-with-python" />

![Space Invaders](/static/images/space-invaders-with-python/banner.png)
...
![Space Invaders](/static/images/space-invaders-with-python/space-invaders.png)
