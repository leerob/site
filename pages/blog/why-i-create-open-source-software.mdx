...
export const meta = {
date: '2019-01-06',
description: 'Creating open-source software makes me happy. It’s an opportunity for me to showcase my programming skills and gain experience with new languages and frameworks.',
...
<DateAndViews date={meta.date} id="why-i-create-open-source-software" />
...
Over four years ago, I wrote <Link slug="blog/space-invaders-with-python" title="Creating a Space Invaders Clone with Python" >this article</Link>
...
![Open Source Software](/static/images/why-i-create-open-source-software/banner.jpg)
