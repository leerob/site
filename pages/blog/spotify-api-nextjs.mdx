...
Here are my top tracks, also shown on my [dashboard](/dashboard).
You can view the source code [here](https://github.com/leerob/leerob.io/blob/master/lib/spotify.js).
