...
export const meta = {
date: '2020-02-24',
description: 'Learn how to fetch data with SWR, a handly React library which improves the developer experience of making a fetch.',
...
In the first three parts of the series, we showed how to fetch data from a variety of APIs.
...
`fetcher` is a small wrapper around `isomorphic-unfetch`.
...
_Note_: The `MetricGrid` and `MetricCard` source code is [here](https://github.com/leerob/leerob.io/blob/master/components/metrics/card.js).
...
That wraps up this series on creating a dashboard. If you missed the previous posts, they are linked below.
