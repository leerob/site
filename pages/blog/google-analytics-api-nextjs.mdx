...
we can retrieve the number of page views in a certain time period programatically.

If you're more concerned about privacy, you might consider using [Fathom](https://usefathom.com/) or [SimpleAnalytics](https://simpleanalytics.com/).
...
_Note_: If you have a lot of environment variables on Now, you might need to [encrpyt your service account](/blog/now-env-variables-size-limit).
