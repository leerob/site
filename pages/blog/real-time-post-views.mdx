...
> Update 2020: I've switched my microservice to an [API route](https://github.com/leerob/leerob.io/blob/master/pages/api/view.js) inside my Next.js application. If you're using Next.js, I would recommend this approach.
...
function Views(props) {
  ...
  return (
    <Container>
      <StyledViews highlight={highlight}>{` - ${props.views &&
        formattedViews}`}</StyledViews>
    </Container>
  );
}
