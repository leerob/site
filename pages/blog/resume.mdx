...
export const meta = {
date: '2020-01-14',
description: 'Want a better programming resume? Limit it to a single page. See how my resume has transformed over the past five years with some actionable advice.',
...
Over the years, I've had many resume iterations. As I moved into my <Link slug="blog/2019" title="2019 Year in Review">new role</Link> last month, I went to update my resume — That's when I realized it was terrible.
...
In 2018, <Link slug="blog/joining-hy-vee" title="Joining Hy-Vee">I switched jobs</Link>. Time to dust off the ol' resume. But, just when you thought it couldn't get worse...
...
-   Unnecessary information is emitted (GPA, projects, internships, phone number).
