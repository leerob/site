...
export const meta = {
date: '2019-03-10',
description: `We spend ~13 years of our life at work, so it's pretty important we enjoy what we're doing and that it connects with our core values. How can you find purpose-driven work?`,
...
-   How does this position align with my <Link slug="blog/benefits-i-care-about-in-2019" title="Benefits I Care About in 2019" underline={true}>core values</Link>?
...
1. I want to be more than _just a programmer_ - I want to utilize my skill set to it's fullest.
