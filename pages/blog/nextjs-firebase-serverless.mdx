...
![Next.js + Firebase + Vercel](/static/images/nextjs-firebase-serverless/banner.png)
...
![BeyondHQ](/static/images/nextjs-firebase-serverless/landing.png)
...
![BeyondHQ](/static/images/nextjs-firebase-serverless/questions.png)
...
![BeyondHQ](/static/images/nextjs-firebase-serverless/geo-eval.png)
...
_Next 9 Update_: The preferred way to handle this now is with [API routes](https://nextjs.org/docs/api-routes/introduction) (e.g., `/pages/api/cities.js`).
...
The magic happens in our `vercel.json` file, which defines how the apps will be deployed. We can route all requests to `/api/` to our Node API:
...
_Next 9 Update_: The preferred way to handle this now is with the [bracket notation](https://nextjs.org/docs/routing/dynamic-routes) (e.g., `/pages/[city].js`).

This gives you the flexibility to add a loading state or placeholder to improve your user experience.

![Loading Placeholder](/static/images/nextjs-firebase-serverless/loading.gif)
