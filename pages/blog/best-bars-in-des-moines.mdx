...
![Des Moines, Iowa](/static/images/best-bars-in-des-moines/banner.png)
...
Hopefully this list helps you discover some new spots or revisit an old favorite. If you’re curious about how I created Guesstimator, you can read my article <Link slug="blog/google-yelp-foursquare-apis-python" title="Harnessing the Google, Yelp, and Foursquare APIs with Python" >here</Link>. Let me know if you agree with the list!
