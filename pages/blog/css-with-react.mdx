...
summary: "Learn how CSS has evolved to it's current state and explore pros and cons of different styling solutions for React."
...
Most comparisons between CSS / CSS-in-JS and their ecosystem fail to consider the scale of the application and the size of the team.
