...
Over the years, I tried about seven different ways to style my React applications. Each solution has its pros and cons.
Most comparisons between CSS/CSS-in-JS and their ecosystem fail to consider the scale of the application and the team's size.
...
different approaches for styling React applications. I'll try to make this comparison as unopinionated as possible.
...
I've tried to summarize pros and cons of various approaches to styling your React application. The choice that's best for you
likely depends on:
...
<ConsCard
  ...
  cons={[
    ...
    'Lack of nesting by default (requires PostCSS).',
...
<ProsCard
  ...
  pros={[
    ...
    'You can take advantage of anything in the JavaScript ecosystem.',
...
<ConsCard
  ...
  cons={[
    'Requires confguring a toolchain like Webpack.',
    'Naming is hard.',
    'Typically uses React Context extensively.',
...
<ProsCard
  ...
  pros={[
    'Great choice for component libraries.',
    'Allows you to enforce a design system easily.',
...
<ConsCard
  ...
  cons={[
    ...
    'Requires toolchain with PurgeCSS to use effectively.',
    'You need to learn Tailwind syntax, which is slightly different than standard CSS.'
  ]}
/>
