...
<ProsCard
  ...
  pros={[
    ...
    'You want the lowest barrier to entry experience.',
...
<ConsCard
  ...
  cons={[
    ...
    `You are publishing a library and don't want to enforce all consumers must use the same CSS-in-JS solution.`
  ]}
/>
