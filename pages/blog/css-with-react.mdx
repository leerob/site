...
React doesn't prescribe how to do many things. This is both it's greatest strength _and_ weakness.

Over the years, I've tried about seven different ways to style my React applications. Each solution has its pros and cons.
...
different approaches for styling React applications.
...
I've tried to summarize pros and cons of various approaches to styling your React application. I'll try to make this comparison as unopinionated as possible.
...
<ConsCard
  title="CSS modules"
  cons={[
    'Requires configuring a toolchain like Webpack.',
