...
also jump to the [list of services](#list-of-services) directly.
...
- [List of Services](#list-of-services)
  - [Database (as a Service)](#database-as-a-service)
    - [Firebase](#firebase)
    - [Hasura](#hasura)
  - [Build Your Own Backend](#build-your-own-backend)
    - [Prisma](#prisma)
  - [Others](#others)
...
If you want complete control, you might consider [building your own](#build-your-own-backend).
...
an entry point to research more. It's also worth mentioning the service you already know well might be your best choice.
...
If you haven't looked at Hasura since they've launched their managed service, give it another look. For me personally, one of the
issues I had before with Hasura was [cold starts](https://medium.com/faun/on-the-serverless-cold-start-problem-2fc0797da5cc) with the [Heroku](https://heroku.com/) free tier. You can prevent that with Hasura Cloud, while still remaining
on the free tier.
...
<ConsCard
  ...
  cons={[
    ...
    'You want authentication included in the platform (it does have authorization, though)'
  ]}
/>
...
If you want to build a GraphQL API with Prisma, you can pair it with [Nexus](https://nexus.js.org/).
...
I haven't worked very closely with the other services listed, but here's some general information you might want to know.

- MongoDB can support GraphQL with [Stitch](https://developer.mongodb.com/how-to/graphql-support-atlas-stitch)
- Founder/startups without funding can apply for [AWS RDS credit](https://aws.amazon.com/about-aws/whats-new/2020/02/aws-launches-activate-founders-package/).
...
Would you change anything? Do you have any resources others could learn from? If so, leave a comment below and I'll update this list.
