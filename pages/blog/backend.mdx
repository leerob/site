...
AWS RDS and Prisma side-by-side feels a bit odd as I see RDS as a way to
deploy and manage a PostgresDB in the cloud while Prisma is
a layer on top of a Postgres DB to simplify a programming model at hand.
