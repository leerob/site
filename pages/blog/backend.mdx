...
you might to fine using [Markdown](https://guides.github.com/features/mastering-markdown/)
...
your own backend, you might also consider a no-code solution.
...
If you want complete control, you might consider [starting from scratch](#starting-from-scratch).
...
The reality is that each service listed here has its own tradeoffs. Hopefully, this gives you a high-level overview to provide
an entry point to research more. First, some questions to consider.
...
| Name                                                         | Type      | Open Source | Free Tier | AuthN Included | GraphQL |
| ------------------------------------------------------------ | --------- | ----------- | --------- | -------------- | ------- |
...
<ConsCard
  ...
  cons={[
    ...
    'You want authentication included in the platform'
  ]}
/>
...
If you answered yes to any of those questions, you might want to explore a CMS. Here are [10 great options](https://bejamas.io/blog/headless-cms/).
