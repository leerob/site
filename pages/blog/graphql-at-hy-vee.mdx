...
<DateAndViews date={meta.date} id="graphql-at-hy-vee" />

![GraphQL at Hy-Vee](/static/images/graphql-at-hy-vee/banner.jpg)

APIs are the backbone of Hy-Vee.

Products, locations, customers, lists, coupons. Data sources that power our company, all powered through APIs.
...
A few months ago, we launched our new [Aisles Online mobile app](https://apps.apple.com/us/app/hy-vee-aisles-online/id1401371704). In the process of evaluating which tech to use, we identified a major requirement:
  ...
  "data": {
    "product": {
      ...
      "productImages": [
        {
          "size": "THUMBNAIL",
          "uri": "https://hy-vee.com/images/37191.jpg",
          "isPrimary": true
        }
      ]
    }
...
const gateway = new ApolloGateway({
    serviceList: [
        {name: 'accounts', url: 'https://api.company.com/graphql'},
        {name: 'reviews', url: 'https://api.company.com/graphql'},
        {name: 'products', url: 'https://api.company.com/graphql'},
        {name: 'inventory', url: 'https://api.company.com/graphql'}
    ]
});
```
...
All new web applications at Hy-Vee are being created with [React](https://reactjs.org/). On mobile, this means [React Nativ](https://facebook.github.io/react-native/)e. Thus, we needed a solution that would work across both web and mobile to consume GraphQL.

[Apollo Client](https://www.apollographql.com/docs/react/) is a complete state management library for JavaScript apps. Simply write a GraphQL query, and Apollo Client will take care of requesting and caching your data, as well as updating your UI.

This makes it dead simple to query your APIs.
