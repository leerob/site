import { getAccessToken, getNowPlaying } from '@/app/lib/spotify';
...
export async function NowPlaying() {
  ...
  const spotifyResponse = await getNowPlaying(access_token);
  ...
  return (
    <div className="flex flex-row-reverse items-center sm:flex-row mb-8 space-x-0 sm:space-x-2 w-full">
      <div className="inline-flex flex-col sm:flex-row w-full max-w-full truncate self-baseline">
        ...
        <span className="pl-2 text-gray-300 text-left text-sm">
          Not Playing
        </span>
      </div>
    </div>
