...
summary: 'Learn how I migrated my Next.js website to use MySQL with PlanetScale, deployed to the edge with Vercel.'
image: '/static/images/mysql-planetscale/banner.png'
---

A few weeks ago, I [moved this site](https://github.com/leerob/leerob.io/pull/326) from using [Firebase](/blog/real-time-post-views) and [Redis](/blog/serverless-redis-nextjs) to PlanetScale. [PlanetScale](planetscale.com) is a serverless database platform built on MySQL and Vitess. Here's why I picked PlanetScale:
...
Same thing with sorting. Before I was using JavaScript `sort` and now I can use `ORDER BY`.
