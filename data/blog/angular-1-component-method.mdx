...
image: '/static/images/posts/comp.jpg'
...
Now if you are really like me you like one specific type of markup and that is _semantic markup_. Markup that really makes sense and tells the story when you see it instead of distracting you will the layout implementation details. Think of it this way. What looks best to you :

## Normal markup

```html
<div class="”friend”">
  <div class="”friend__image”"></div>
...
In directives we have a _scope_ where like we mentioned we can have inherited scope or isolated (new) scope for the directive. Usually and this has kind of become the standard you create an isolated scope for the directives and use _bindToController_ to pass in the necessary properties we want to pass from the controller to the directive.
