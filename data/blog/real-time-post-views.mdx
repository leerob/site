...
1. [Who Is This For?](/blog/real-time-post-views#who-is-this-for)
1. [Technical Overview](/blog/real-time-post-views#technical-overview)
1. [Setting Up Firebase](/blog/real-time-post-views#setting-up-firebase)
1. [Creating The Microservice](/blog/real-time-post-views#creating-the-microservice)
1. [Deploying and Testing View Counts](/blog/real-time-post-views#deploying-and-testing-view-counts)
1. [Lazy-Loading Firebase Client Side](/blog/real-time-post-views#lazy-loading-firebase-client-side)
1. [Real-Time View Count Updates](/blog/real-time-post-views#real-time-view-count-updates)
1. [Conclusion](/blog/real-time-post-views#conclusion)
