---
title: 'Decouled multifrontends with Next.js and Drupal'
...
At jobiqo.com we use [Next.js](https://nextjs.org/) together with a [Drupal](https://www.drupal.org/) backend. We make job boards and one of the common requests that we have is to have one backend managing multiple frontends, we call these types of projects Multifrontend projects.
