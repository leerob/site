...
summary: 'TODO'
image: '/static/images/devrel-at-vercel/og.png'
---
...
One of my goals is to create a positive, uplifting, and vibrant community of developers who are exciting about making the web faster. This means you'll find me or others on the team in GitHub, Twitter, Discord, Reddit, Facebook, Hacker News, and everywhere else online learning about how developers use our products and where we can improve.

In the process of educating developers about the tools and products we provide, we learn what is working well and what's not. Our team then is able to work with product to relay valuable customer insights so we can iterate towards the best customer experience. Feedback, as they say, is a gift.
...
High trust teams are [high growth teams](/blog/hypergrowth). I want to create a team that trusts each other, has autonomy to get their work down, and is given ownership over some part of the experience.
...
That's all for now. Drop me an email at `lee@vercel.com` and let's chat if you're interested.
