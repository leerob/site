...
summary: 'Thoughts on what makes a great developer experience and where my team is headed.'
image: '/static/images/dx/banner.png'
---

Developers want to be productive – but are often slowed down by the developer experience of their tools.

Tools that keep developers in the flow state have a magnetic force. An often unexplainable, invisible pull that attracts and retains them to certain products. This pull is developer experience.
...
**It's an honor to share that I am now the VP of Developer Experience at Vercel** to continue to invest in the foundations of DX and community as a core part of the company strategy.

This post outlines my thoughts on what makes a great developer experience and how we'll focus on making Vercel the best platform for frontend developers.
...
- **Education:** Enable developers of all experience levels to make the web faster.
...
Here's a collection of opinions I hold on what makes a great developer experience. Note that some of these apply more broadly than their category (e.g. frameworks).
...
- **Let me try out APIs quickly:** Some of my favorite API documentation allows you to generate an API key and try out endpoints in a few seconds. Some even recognize that you're already logged in and personalize the page based on your account information. Square's documentation does this well. I also like GraphiQL for this – you view the entire graph schema, make requests, run mutations, format your code, and more.

<StaticTweet id="1471351025252519936" />

## Conclusion

With the Developer Experience organization now part of the Vercel leadership team, we're doubling down on creating the best platform for frontend developers.

Drop me an email at `lee@vercel.com` with three paragraphs on how you've impacted developer experience at scale if you're interested in joining the team.
