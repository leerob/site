...
image: '/static/images/posts/electron.jpg'
...
<html lang="">
  <head>
    <title>Angular 2 Electron</title>
    <meta charset="utf-8" />
...
**_Don’t use this in production as for production you should have a safe server side URI and not have your secret key in the app folder._**
