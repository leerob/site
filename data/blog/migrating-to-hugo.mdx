...
[Hugo](http://gohugo.io/) describes itself as "the world’s fastest framework for building websites". Based on my experience with another static site generator called [Jekyll](https://jekyllrb.com/), I would have to agree. At less than 1 ms per page, the average site builds in less than a second. Hugo allows me to write my blog posts in [Markdown](https://en.wikipedia.org/wiki/Markdown) and have them compiled to create a static website. It also includes pre-made templates for common add-ons like SEO (Search Engine Optimization), comments, analytics, and more.
