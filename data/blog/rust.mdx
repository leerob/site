...
image: '/static/images/rust/banner.png'
---
...
Rome is currently written in TypeScript and runs on Node.js. But they're now working on [rewriting in Rust](https://twitter.com/rometools/status/1422616144763097091).
...
I believe Rust is the future of JavaScript tooling. [Next.js 12](http://nextjs.org/12) started our transition to fully place Babel (transpilation) and Terser (minification) with SWC and Rust. Why?
...
- [Rome](https://rome.tools/) is [rewriting in Rust](https://twitter.com/rometools/status/1422616144763097091) and planning on using SWC,
...
- **Plugins:** Writing plugins in Rust isn't as approachable for many JavaScript developers. At the same time, exposing a plugin system in JavaScript could negate performance gains. A definitive solution hasn't emerged yet.
