...
- Cross-browser support for [nesting](https://caniuse.com/css-variables), [:has()](https://caniuse.com/css-has), [container queries](https://caniuse.com/css-container-queries), and more¹
...
To solve these issues, “zero runtime” CSS-in-JS libraries like [Vanilla Extract](https://vanilla-extract.style/) and others have been created.
...
Creating the example above was my first time using StyleX. While it's still new to open-source (and the ecosystem reflects that), it's _not_ a new library. It powers all the Meta sites: Facebook, Instagram, WhatsApp, and Threads.
...
Would you have picked something different? Did I miss anything? [Lmk](https://twitter.com/leeerob).
