...
For example, this was the reaction to a demo built using Next.js.

<StaticTweet id="1744201046627356885" />

Great developer marketing would show me how to build this experience.
...
Trust is built (or lost) through the content your create and put out into the community. It’s a reflection of what you stand for.
...
3. When something sucks with your product, own it. Don’t try to hide the failure. Lean into it. Bring the community along for the continuous iteration of your product. “You told you this was bad, and we fixed it”. Follow up with people after you ship.
