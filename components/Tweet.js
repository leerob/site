    ...
    <div className="rounded border border-gray-300 dark:border-gray-800 px-6 py-4 my-4 w-full">
      ...
      <div className="flex text-gray-700 dark:text-gray-300 mt-2">
        ...
        >
          ...
          <span>{new Intl.NumberFormat().format(public_metrics.reply_count)}</span>
        </a>
        <a
        ...
        >
          ...
          <span>{new Intl.NumberFormat().format(public_metrics.retweet_count)}</span>
        </a>
        <a
        ...
        >
          ...
          <span>{new Intl.NumberFormat().format(public_metrics.like_count)}</span>
        </a>
      </div>
    </div>
  );
