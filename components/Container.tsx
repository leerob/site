  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900">
      ...
      <div className="flex flex-col justify-center px-8">
        <nav className="flex items-center justify-between w-full max-w-2xl mx-auto pt-8 pb-8 sm:pb-16  text-gray-900 bg-gray-50 sticky-nav dark:bg-gray-900 bg-opacity-60 dark:text-gray-100">
