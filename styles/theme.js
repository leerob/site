...
const theme = {
  ...
  icons: {
    ...
    devskills: {
      path: (
        <g fill="currentColor">
          <path d="M327.6 66.7c-.2 1-8.4 30.1-18.1 64.8-9.7 34.6-18.1 63.4-18.6 63.9s-12.8-4.2-30.1-11.7c-30.2-12.9-119.3-51.3-133-57.2-4.3-1.9-7.9-3.1-8.2-2.7-.7 1.3-49.1 293.1-48.6 293.6.8.7 102.3 17.6 102.9 17.1.2-.3 6.4-36.3 13.7-80 7.3-43.8 13.4-79.9 13.6-80.4.3-.9 7.3 2.1 74.8 31.2 17.3 7.4 43.1 18.5 57.4 24.7 14.2 6.1 25.9 11 26.1 10.8.3-.4 69.5-246.2 69.5-246.9 0-.4-2.1-1.2-4.7-1.9-3.5-.8-80.7-22.6-94.5-26.6-1-.3-1.8.2-2.2 1.3z" />
        </g>
      ),
      viewBox: '0 0 500 500',
      width: '666.667',
